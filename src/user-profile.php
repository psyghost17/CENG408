							...
							<section class="panel">
								...
								<div class="panel-body">
									...
									<div class="thumb-info mb-md">
										...
										<?php
											echo '<img src="data:images/jpeg;base64,'.(user::getImage($row['image'])).' width="175" height="200" />';
									...
									<p><b>Welcome <?php echo $user['name']?>!</b></p>
								...
								<div class="tab-content">
									...
									<div id="details">
											...
											<fieldset>
												...
												<div class="form-group">
													<label class="col-md-3 control-label" for="logo">Image</label>
